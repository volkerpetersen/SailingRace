...
public class GlobalParameters {
    ...
    public HashMap<String, HashMap> raceCourses;       // HashMap to hold the race course coordinates
    private HashMap<Integer, Double[]> raceWaypoints;  // HashMap to hold the waypoint coordinates for one race
    ...
    public static synchronized GlobalParameters getInstance() {
        if (mInstance == null) {
            ...
            mInstance.raceCourses  = new HashMap<String, HashMap>();
            mInstance.initRaceCources();
        }
        return mInstance;
    }

    private void initRaceCources() {
        // initialize the Big Island Race - clockwise around the island - Lat / Lon pairs
        // see VariousAppDevelopmentAssets/WYC_BigIslandRace.gpx for OpenCPN (counter-clockwise) route
        raceWaypoints = new HashMap<Integer, Double[]>();
        raceWaypoints.put(1, new Double[] {44.934884893, -93.551346386});
        raceWaypoints.put(2, new Double[] {44.932997139, -93.550151007});
        raceWaypoints.put(3, new Double[] {44.928635539, -93.550334912});
        raceWaypoints.put(4, new Double[] {44.919195123, -93.565690932});
        raceWaypoints.put(5, new Double[] {44.920041568, -93.572955158});
        raceWaypoints.put(6, new Double[] {44.925380399, -93.580955001});
        raceWaypoints.put(7, new Double[] {44.929937544, -93.580403287});
        raceWaypoints.put(8, new Double[] {44.931434813, -93.575529820});
        raceWaypoints.put(9, new Double[] {44.936772584, -93.559162325});
        raceWaypoints.put(10,new Double[] {44.936382033, -93.554013001});
        raceCourses.put("Big Island Race", raceWaypoints);

        // initialize the Commodore Cup - clockwise around the island - Lat / Lon pairs
        // see VariousAppDevelopmentAssets/WYC_CommodoreCup.gpx for OpenCPN (counter-clockwise) route
        raceWaypoints = new HashMap<Integer, Double[]>();
        raceWaypoints.put(1, new Double[] {44.963128692, -93.510979362});
        raceWaypoints.put(2, new Double[] {44.958574180, -93.525323908});
        raceWaypoints.put(3, new Double[] {44.953563800, -93.529737615});
        raceWaypoints.put(4, new Double[] {44.935405641, -93.546472919});
        raceWaypoints.put(5, new Double[] {44.927138198, -93.550151007});
        raceWaypoints.put(6, new Double[] {44.918348665, -93.565874837});
        raceWaypoints.put(7, new Double[] {44.920171790, -93.574610298});
        raceWaypoints.put(8, new Double[] {44.925380399, -93.580955001});
        raceWaypoints.put(9, new Double[] {44.929937544, -93.580403287});
        raceWaypoints.put(10,new Double[] {44.931434813, -93.575529820});
        raceWaypoints.put(11,new Double[] {44.937879134, -93.560173799});
        raceWaypoints.put(12,new Double[] {44.953563800, -93.529737615});
        raceWaypoints.put(13,new Double[] {44.958574180, -93.525323908});
        raceWaypoints.put(14,new Double[] {44.963128692, -93.510979362});
        raceCourses.put("Commodore Cup", raceWaypoints);
    }
